...
export class NetworkComponent {
 ...
 hospitalLocations: Location[] = [
  {
   ...
   shortLocation: 'Mayur Vihar Phase-I, Delhi',
   ...
   streetViewUrl: 'https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=28.60691070696357,77.29596978858156'
  },
  {
   branchName: 'Lawrence Road Branch',
   shortLocation: 'Keshavpuram, Delhi',
   ...
   streetViewUrl: 'https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=28.68975231215174,77.16094850828438'
  },
  {
   branchName: 'Durgapuri Branch',
   shortLocation: 'Durgapuri, Shahdara',
   ...
   streetViewUrl: 'https://www.google.com/maps/search/?api=1&query=C-45+West+Jyoti+Nagar+Durgapuri+Delhi'
  },
  {
   branchName: 'Uttam Nagar Branch',
   shortLocation: 'Uttam Nagar, Delhi',
   ...
   streetViewUrl: 'https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=28.62084153104128,77.04939339192077'
  },
  {
   branchName: 'Tigri Branch',
   shortLocation: 'JJ Colony Tigri, New Delhi',
   ...
   streetViewUrl: 'https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=28.51170377389819,77.23801085778919'
  }
 ];
 ...
 // Highlight a branch (used on hover/focus of pins and list items)
 setActive(index: number | null) {
  this.activeIndex = index;
 }

 // 📜 Scroll to the selected branch card and highlight it
