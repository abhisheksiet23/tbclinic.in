export interface BlogPost {
  ...
  excerpt: string;
  body: string;
  /** Short bullet summary shown above the article body for quick skimming. */
  takeaways: string[];
  tag: string;
  image: string;
  author: string;
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    takeaways: [
      'Typhoid spreads through food/water and clears with a short antibiotic course.',
      'TB is airborne, needs longer treatment, and often shows a persistent cough plus weight loss.',
      'Fever lasting more than a week without a clear cause deserves targeted testing, not guesswork.'
    ],
    tag: 'Awareness',
  ...
  },
  {
    ...
    takeaways: [
      'TB is curable in most cases when the full treatment course is completed.',
      'Standard treatment takes about 6 months; drug-resistant TB takes longer.',
      'Family transmission risk drops quickly once treatment starts and precautions are followed.'
    ],
    tag: 'FAQ',
